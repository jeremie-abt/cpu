...
// parseOperand parse un opérande (registre, immédiat, mémoire, label)
// func (p *ProgramAST) parseOperand() *Operand

// parseMemoryOperand parse [eax], [ebx+4], etc.
// func (p *ProgramAST) parseMemoryOperand() *MemoryOperand
